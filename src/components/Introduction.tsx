...
{/* Section 1: Mathematical Foundation */}
        ...
        <section className="insight-info">
          ...
          <div className="insight-warning">
            <h4>⚠️ The Ratiometric Problem</h4>
            <p>
        ...
        {/* Section 3: Educational Scope & Limitations */}
        <section className="insight-warning">
          <header>
            <h3>⚖️ Educational Scope & Important Limitations</h3>
          </header>
          ...
          <div className="insight-success">
            ...
            <p>
              Click <strong>"Scaling Comparison"</strong> to see these principles in action. 
